  ...
  <div class="wrapper">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        ...
        <li >
          <a href="#studentSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Add Country</a>
    ...
    <div id="content">
      ...
      <div>
        ...
        <form method="post" id="add_form" action="process_crud_requests.php" enctype='multipart/form-data'>
          <input type="hidden" name="identifier" value="add_country">
          <div class="form-group">
            <label for="exampleFormControlInput1">Country Name</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Pakistan" name="name">
          </div> 
