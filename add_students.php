  ...
  <div class="wrapper">
    ...
    <div id="content">
      ...
      <div>
        ...
        <?php endif;?>
        <form method="post" action="process_crud_requests.php" enctype='multipart/form-data' id="add_student_form">
          <input type="hidden" name="identifier" value="add_student">
          <div class="form-group">
            <label for="exampleFormControlInput1">Full Name</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="John Smith" name="full_name">
          </div> 
          <div class="form-group">
            <label for="exampleFormControlInput2">Date Of Birth</label>
            <input type="text" class="form-control" id="datepicker-11"  name="date_of_birth">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput3" placeholder="03152611244" name="telephone">
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="exampleFormControlSelect2">Course Selection</label>
            <select multiple class="form-control" id="exampleFormControlSelect2" name="courses[]">
             <?php 
        ...
        <button type="button" id="submit_btn_add_form" class="btn btn-primary ">Submit</button>
      </form>
    </div>
