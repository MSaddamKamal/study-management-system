      ...
      <div>
        <?php if(isset($_GET['message'])):?>
          <div class="alert alert-success" role="alert">
            <strong>Success!</strong> course created succesfully.
          </div>
        <?php endif;?>
        ...
        <form method="post" id="add_form" action="process_crud_requests.php" enctype='multipart/form-data'>
          <input type="hidden" name="identifier" value="add_course">
          <div class="form-group">
            <label for="exampleFormControlInput1">Course Name</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Maths" name="name">
          </div> 
